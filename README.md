...
[GTSinger](https://huggingface.co/datasets/GTSinger/GTSinger) の日本語歌唱から、2 人の歌手と 6 種類の歌唱条件について、通常歌唱と技法歌唱を各 1 クリップ選びました。重複しない計 24 クリップを歌詞なしで現行の Soramimic Score に入力し、全件で解析が完了しました。正解音符は計 407 個です。

| 開始時刻・音高の許容差 | Score の音符 F1 |
| --- | ---: |
| ±50 ms・±50 セント | 27.8% |
| ±100 ms・±1 半音 | 58.4% |
| ±200 ms・±1 半音 | 67.8% |
...
注：この 24 クリップでは Score の音高を採点時に一律 12 半音下げました。音符の時刻は移動していません。
